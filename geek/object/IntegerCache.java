 ...
 * 可以通过 VM 参数 {@code -XX:AutoBoxCacheMax=N};{@code -XX:+AggressiveOpts}(会将high提升至20000);
 * {@code -Djava.lang.Integer.IntegerCache.high=255};
 * 调整缓存上限值 {@link Integer.IntegerCache#static}; 但是Java不支持{@link Integer.IntegerCache#low}的更改;
