...
public class PinYinUtil {
    ...
    public static void main(String[] args) {
        String input = RandomDataGenerator.randomName(true);
        System.out.println(input);
        System.out.println(getFirstSpell(input));
        System.out.println(getFullSpell(input));
        System.out.println(getPingYin(input));
    }
}
